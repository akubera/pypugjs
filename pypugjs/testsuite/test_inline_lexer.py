...
expected_results = {
    "p Here is some #[strong: em text] and look at #[a(href='http://google.com') this link!]": [
        ...
        {'inline_level': 1, 'val': None, 'buffer': None, 'static_attrs': set([u'href']),
         'attrs': odict([(u'href', u"'http://google.com'")]), 'line': 1, 'type': 'attrs'},
    ...
    "p We can also #[strong combine #[em multiple #[img(src='http://jade-lang.com/style/logo.png')]]]": [
        ...
        {'inline_level': 3, 'val': None, 'buffer': None, 'static_attrs': set([u'src']),
         'attrs': odict([(u'src', u"'http://jade-lang.com/style/logo.png'")]), 'line': 1, 'type': 'attrs'},
        {'buffer': None, 'type': 'string', 'line': 1, 'inline_level': 2, 'val': u''},
        {'buffer': None, 'type': 'string', 'line': 1, 'inline_level': 1, 'val': u''},
        {'buffer': None, 'line': 1, 'type': 'string', 'inline_level': 0, 'val': u''}],
    ...
    "p Another #[strong.lil#okf(acs=[1,2]) test [[with brackets]] [in#[='side']]]": [
        ...
        {'val': None, 'buffer': None, 'static_attrs': set([]), 'attrs':
            odict([(u'acs', u'[1,2]')]), 'line': 1, 'type': 'attrs', 'inline_level': 1},
...
p Test inline mixin #[+lala(123, 'lala inside inline')] end""": [
    ...
    "#[asdf.lol(fff)#[asdf]]": [
        ...
        {'inline_level': 1, 'val': None, 'buffer': None, 'static_attrs': set([u'fff']), 'attrs': odict([(u'fff', True)]), 'line': 1,
         'type': 'attrs'},
